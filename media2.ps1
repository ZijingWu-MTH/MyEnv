...
. .\cue.ps1 e:\source_code\bj-media2 e:\source_code\bj-media\cue

$env:OBJPOSTFIX="-media2-x64"
...
$env:QT_PATH = "e:\opensource\qt5-build\qtbase"
...
$env:PATH="$env:PATH;C:\Program Files\LLVM\bin\;E:\android_studio\platform-tools"
...
$env:PATH="$env:PATH;E:\installation\jom"
